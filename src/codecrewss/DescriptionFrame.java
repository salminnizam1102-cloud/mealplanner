...
public class DescriptionFrame extends JFrame {
    public DescriptionFrame() {
        ...
        JPanel panel = new JPanel(new BorderLayout()) {
            private Image backgroundImage = new ImageIcon("assets/background.jpg").getImage(); // Update path
        ...
        JLabel label = new JLabel(
            ...
            "• Breakfast: Energizing start with fiber-rich carbs and nuts (35% of calories)<br>" +
            "• Lunch: Lean protein salad for balanced midday fuel (40% of calories)<br>" +
            "• Dinner: Light, low-calorie option to end the day (25% of calories)<br><br>" +
            "<font color='blue' size='+1'>FEATURES.</font><br><br>" +
        ...
        label.setBackground(new Color(255, 255, 255, 200)); // Semi-transparent white background
